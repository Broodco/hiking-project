            ...
            <form class="mt-8 space-y-6" action="/register" method="POST">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    ...
                    <div>
                        ...
                        <input id="user_name" name="user_name" type="text" required class="appearance-none rounded-none relative block mb-2 w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="User Name">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input id="last_name" name="last_name" type="text" required class="appearance-none rounded-none relative block mb-2 w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Last Name">
                    </div>
                    <div>
