...
<div class="bg-white shadow px-4 py-5 sm:rounded-lg sm:p-6">
    <div class="min-h-full flex items-center justify-center py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div>
                <h2 class="mt-2 text-center text-3xl tracking-tight font-bold text-gray-900">Log into your account</h2>
            </div>
            <form class="mt-8 space-y-6" action="/login" method="POST">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    <div>
                        ...
                        <input id="email-address" name="email" type="email" autocomplete="email" required class="appearance-none rounded-none relative block mb-2 w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-gray-500 focus:border-gray-700 focus:z-10 sm:text-sm " placeholder="Email address">
                    </div>
                    <div>
